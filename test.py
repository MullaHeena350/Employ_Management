...
class employee:
    def __init__(self,root):# here instead root u can use anyother words like master .it just indicates window name
       ...
       #fg=foreground for letters coloring
        ...
        img_logo=Image.open('/home/student/Desktop/Employ_Management/collage/logo.png')
        ...
        img_frame.place(x=0,y=50,width=1530,height=115)
                    #1st_Image
        img1=Image.open('/home/student/Desktop/Employ_Management/collage/t1.jpeg')
        ...
        self.img_1.place(x=0,y=0,width=540,height=110)
                #2nd_Image
        img2=Image.open('/home/student/Desktop/Employ_Management/collage/t2.jpeg')
        ...
        self.img_2.place(x=540,y=0,width=540,height=110)
                #3rd_Image
        img3=Image.open('/home/student/Desktop/Employ_Management/collage/t3.jpeg')
